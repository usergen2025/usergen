  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        videoStyle: { type: 'string', enum: ['HALF_N_HALF', 'ALTERNATE', 'AVATAR_CUTOUT', 'AVATAR_ONLY', 'PRODUCT_ONLY', 'AVATAR_PRODUCT'], example: 'HALF_N_HALF', description: 'Video style/format' },
